...
$columns = ['id', 'concepto', 'precio','unidad'];
...
if ($num_rows > 0) {
    while ($row = $resultado->fetch_assoc()) {
        ...
        $output['data'] .= '<td>
        <a class="btn btn-secondary" href="actualizar-pre.php?id='. $row['id'] . '"><img src="../img/editar.png" alt="" style="width: 25px; height: 25px;"></a>
        </td>';
        $output['data'] .= '</tr>';
    }
} else {
