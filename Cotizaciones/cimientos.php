    ...
    <section id="container">
       ...
       <table class="table" style="background-color: #681319; color:white; margin-bottom: -1px;">
        ...
        <tbody id="content">
                ...
                <tr>
                    <td><?php $retirarescesodetierra = "Retirar exceso de tierra"; echo $retirarescesodetierra;?></td>
                    <td>
                        <?php 
                            
                        ?>
                    </td>
                    <td>$ <?php $precio_retirare = 600; echo number_format($precio_retirare, 2);?></td>
                    <td>$
                         <?php 
                    ...
                    <td><?php $unidad_retirare = "Camion"; echo $unidad_retirare;?></td>
                </tr>
