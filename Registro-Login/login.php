...
// Check if the user is already logged in, if yes then redirect him to Panel page
        ...
        <div class="sub-contenedor">
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                ...
                <div class="form-group" style="text-align: center;">
                    <input type="submit" class="btn" value="Ingresar" style="background-color: #681319; color: white;"> <br> <br>
                </div>
