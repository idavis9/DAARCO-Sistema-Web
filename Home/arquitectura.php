...
<body style="background-color: #e0e0e0">
    ...
    <div class="container-tarjetas">
        ...
        <div class="col">
            ...
            <img src="./diseno/1/1.jpg" class="card-img-top" alt="...">
        ...
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/2/1.jpg" class="card-img-top" alt="...">
        ...
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/3/1.jpg" class="card-img-top" alt="...">
            <div class="status">En construcción</div>
            <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><h5 class="card-title">Casa Habitación</h5></li>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/4/1.jpg" class="card-img-top" alt="...">
            <div class="status">Por construir</div>
            <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><h5 class="card-title">Casa Habitación</h5></li>
        ...
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/5/1.jpg" class="card-img-top" alt="...">
            <div class="status">Por construir</div>
            <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><h5 class="card-title">Casa Habitación</h5></li>
        ...
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/6/1.jpg" class="card-img-top" alt="...">
            <div class="status">En construcción</div>
            <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><h5 class="card-title">Casa Habitación</h5></li>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/7/1.jpg" class="card-img-top" alt="...">
            <div class="status">Por construir</div>
            <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><h5 class="card-title">Casa Habitación</h5></li>
        ...
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/8/1.jpg" class="card-img-top" alt="...">
            <div class="status">Por construir</div>
            <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><h5 class="card-title">Casa Habitación</h5></li>
        ...
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/9/1.jpg" class="card-img-top" alt="...">
            <div class="status">En construcción</div>
            <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><h5 class="card-title">Restaurante</h5></li>
                <li class="list-group-item"><p class="card-text">Estilo: Minimalista</p></li>
                <li class="list-group-item"><button type="button" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Bed Room">5</button>
                <button type="button" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Living Room">2</button>
                <button type="button" class="btn btn-secondary" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Parking">2</button>
    ...
    <div class="row row-cols-1 row-cols-md-3 g-4">
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/10/1.png" class="card-img-top" alt="...">
            <div class="status">En construcción</div>
            <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><h5 class="card-title">Casa Habitación</h5></li>
        ...
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/11/1.jpg" class="card-img-top" alt="...">
            <div class="status">En construcción</div>
            <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><h5 class="card-title">Casa Habitación</h5></li>
        ...
        <div class="col">
            <div class="card h-100">
            <img src="./diseno/12/1.jpg" class="card-img-top" alt="...">
            <div class="status">En construcción</div>
            <div class="card-body">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"><h5 class="card-title">Casa Habitación</h5></li>
  ...
  <ul class="pagination pagination-sm">
    ...
    <li class="page-item"><a class="page-link" href="arquitectura2.php" style="color: #282936;">2</a></li>
    <li class="page-item">
      <a class="page-link" href="arquitectura2.php" style="color:#282936;">Next</a>
    </li>
  </ul>
</nav>
